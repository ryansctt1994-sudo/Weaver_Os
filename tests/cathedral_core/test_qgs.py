...
def test_qgs_levels_are_ordered():
    ...
    assert QGSLevel.E4_REPLICATED < QGSLevel.E5_AUDITED


def test_e5_production_bound_alias_preserves_backward_compatibility():
    assert QGSLevel.E5_PRODUCTION_BOUND is QGSLevel.E5_AUDITED
